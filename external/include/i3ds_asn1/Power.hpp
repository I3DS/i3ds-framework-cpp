...
#define i3ds_asn1_ERR_POWERMASK		3702  /**/
#define i3ds_asn1_i3ds_asn1_ERR_POWERMASK_ELM_2		3697  /**/
flag PowerMask_IsConstraintValid(const PowerMask* pVal, int* pErrCode);

#define i3ds_asn1_ERR_UPER_ENCODE_POWERMASK		3703  /**/
#define i3ds_asn1_i3ds_asn1_ERR_UPER_ENCODE_POWERMASK_ELM_2		3698  /**/
...
#define i3ds_asn1_ERR_UPER_DECODE_POWERMASK		3704  /**/
#define i3ds_asn1_i3ds_asn1_ERR_UPER_DECODE_POWERMASK_ELM_2		3699  /**/
...
#define i3ds_asn1_ERR_POWEROUTPUT		3683  /**/
flag PowerOutput_IsConstraintValid(const PowerOutput* pVal, int* pErrCode);

#define i3ds_asn1_ERR_UPER_ENCODE_POWEROUTPUT		3684  /**/
...
#define i3ds_asn1_ERR_UPER_DECODE_POWEROUTPUT		3685  /**/
